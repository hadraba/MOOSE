...
def predict(task, model_name: str, input_dir: str, output_dir: str, accelerator: str, model_download_folder:str) -> None:
    """
    ...
    task.update(message = "Postprocessing images…")
